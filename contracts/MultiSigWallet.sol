...
contract MultiSigWallet {
    ...
    event SubmissionPassed(uint indexed transactionId, uint confirmationTime);
    event SubmissionDisputed(uint indexed transactionId);
    ...
    function executeTransaction(uint transactionId)
        ...
        notExecuted(transactionId)
    {
        // TODO: can delete remove isConfirmed from if statement
      ...
      internal
    {
      ...
      if (confirmationTime == 0) {
        SubmissionDisputed(transactionId);
      } else {
        SubmissionPassed(transactionId, confirmationTime);
      }
    }
